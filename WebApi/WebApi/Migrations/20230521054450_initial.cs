    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StrategyName = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    StrategyId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Strategy", x => x.StrategyName);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClusterCreated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    IsUpdated = table.Column<int>(type: "integer", nullable: false),
                    Username = table.Column<string>(type: "character varying(15)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cluster", x => x.ClusterId);
                    table.ForeignKey(
                        name: "FK_Cluster_User_Username",
                        column: x => x.Username,
                        principalTable: "User",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClusterDataUrlId = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UrlId = table.Column<Guid>(type: "uuid", nullable: false),
                    StrategyName = table.Column<string>(type: "character varying(10)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UrlStrategies", x => new { x.UrlId, x.StrategyName });
                    table.ForeignKey(
                        name: "FK_UrlStrategies_Strategy_StrategyName",
                        column: x => x.StrategyName,
                        principalTable: "Strategy",
                        principalColumn: "StrategyName",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UrlStrategies_URL_UrlId",
                        column: x => x.UrlId,
                        principalTable: "URL",
                        principalColumn: "UrlId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_URL_ClusterId",
                table: "URL",
                column: "ClusterId");

            migrationBuilder.CreateIndex(
                name: "IX_UrlStrategies_StrategyName",
                table: "UrlStrategies",
                column: "StrategyName");
        }
